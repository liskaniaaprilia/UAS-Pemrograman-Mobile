...
public class MainTheGoodBadMother extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_thegoodbadmother);

        VideoView videoView = findViewById(R.id.video_thegood);
